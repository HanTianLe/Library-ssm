...
<div id="main">
    <div class="navigation">
        ...
        <div id="readerBlock">欢迎回来&nbsp;:
            <%--这边 page 默认设置 = 1。（为了页面初始化使用。）--%>
            <a href="/reader/findAllBorrow/1/${sessionScope.reader.id}">${sessionScope.reader.name}</a>&nbsp;
            <a href="/logout">注销</a>
        </div>
    </div>
    <div class="img_block">
    ...
    <table class="table" cellspacing="0">
        ...
        <c:forEach items="${list}" var="book">
            <tr>
                ...
                <td>${book.pages}</td>
                <td>${book.price}</td>
                <td>${book.bookCaseName}</td>
                <td>
                    <a href="/reader/addBorrow/${sessionScope.reader.id}/${book.id}">借阅</a>
                </td>
            </tr>
        </c:forEach>
    </table>
