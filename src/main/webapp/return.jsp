	  ...
	  <script type="text/javascript">
		  $(function(){
			  $("#next").click(function(){
				  ...
				  page++;
				  location.href = "/admin/findAllBorrowByState/"+page+"/1";
			  })
			  ...
			  $("#first").click(function () {
				  location.href = "/admin/findAllBorrowByState/1/1";
			  })

			  $("#last").click(function(){
				  var pages = parseInt($("#pages").html());
				  location.href = "/admin/findAllBorrowByState/"+pages+"/1";
			  })
		  })
	  </script>
  </head>
    ...
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				当前位置:&nbsp;&nbsp;<a href="/admin/findAllBorrowByState/1/0">借书管理</a>
		...
		<table class="table" cellspacing="0">
			...
			<tr>
				...
				<td><a href="/admin/borrowHandler/${sessionScope.admin.id}/${borrow.id}/3">归还</a></td>
			</tr>
			</c:forEach>
